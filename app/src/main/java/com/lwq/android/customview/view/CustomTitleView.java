package com.lwq.android.customview.view;
...
import com.lwq.android.customview.R;
...
/**
 * Created by LiWeiQiang on 2016/10/4.
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (specMode) {
            case MeasureSpec.EXACTLY://明确指定了
                ...
                break;
            case MeasureSpec.AT_MOST://一般为WARP_CONTENT
                height = getPaddingTop() + getPaddingBottom() + mBound.width();
                break;
        }
